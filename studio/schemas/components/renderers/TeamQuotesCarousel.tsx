...
import { TeamQuotesCarousel } from '../../generated-schema';
...
const TeamQuotesCarouselComponent: React.FunctionComponent<TeamQuotesCarouselProps> =
  ({ value }: TeamQuotesCarouselProps): ReactElement => {
    ...
    const nextItem = () => {
      ...
      if (nextIndex > -1 && nextIndex < (value?.quotes?.length ?? 0)) {
    ...
    const getQuoteSelected: any = () => {
      return (
        ...
        value.quotes[quoteSelectedIndex]
      );
    };
